...
class DDPG3(BaseAgent):
    ...
    def save_model(self):
        self.actor_target.model.save_weights('actor_weights.h5')
        self.critic_target.model.save_weights('critic_weights.h5')

        # with open("actor.json", "w") as json_file:
        #     json_file.write(actor)
        # with open("critic.json", "w") as json_file:
        #     json_file.write(critic)

        # self.actor_target.save_weights("actor.h5")
        print("Actor saved model to disk")

        # self.critic_target.save_weights("critic.h5")
        print("Critic saved model to disk")